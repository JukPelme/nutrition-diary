...
const TRANSLATIONS = {
    ...
    en: {
        ...
        applyDay: 'Apply to diary', mealPlanNone: 'No active plan — tap Generate', tips: 'Tips', confirmApplyDay: 'Apply day ', toDiary: ' to diary?', appliedEntries: 'Entries added: ', confirmDeletePlan: 'Delete this plan?', mealPlanGenerating: 'Generating menu… 30-60s', mealPlanReady: 'Done!', mealPlanExpired: 'No plan for today — showing the latest', mealPlanHistory: 'Plan history', shown: 'shown', open: 'Open',
    ...
    ja: {
        ...
        applyDay: '日記に反映', mealPlanNone: 'アクティブな献立はありません — 「生成」をタップ', tips: 'ヒント', confirmApplyDay: '日付 ', toDiary: ' を日記に反映しますか?', appliedEntries: '追加した記録数: ', confirmDeletePlan: 'この献立を削除しますか?', mealPlanGenerating: '献立を生成中… 30〜60秒', mealPlanReady: '完了!', mealPlanExpired: '本日の献立はありません — 最新を表示', mealPlanHistory: '献立履歴', shown: '表示中', open: '開く',
