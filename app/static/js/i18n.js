...
const TRANSLATIONS = {
    ru: {
        ...
        adminPanel: '🛠 Админка', openAdmin: 'Открыть панель', loading: 'Загрузка…',
    ...
    en: {
        ...
        adminPanel: '🛠 Admin', openAdmin: 'Open panel', loading: 'Loading…',
    ...
    ja: {
        ...
        adminPanel: '🛠 管理', openAdmin: 'パネルを開く', loading: '読み込み中…',
