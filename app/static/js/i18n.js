...
const TRANSLATIONS = {
    ru: {
        ...
        waistCm: 'Обхват талии, см', bodyFatPct: '% жира',
        adminPanel: '🛠 Админка', openAdmin: 'Открыть панель', loading: 'Загрузка…', historyTitle: '📖 История питания', historyEmpty: 'Пока нет записей', repeat: 'Повторить', repeatDay: 'Повторить день', otherMeal: 'Другое', repeatDayConfirm: 'Скопировать день в сегодня', addedToToday: 'Добавлено в сегодня',
        adminOverview: 'Обзор', adminUsers: 'Юзеров', adminActive24h: 'Актив 24ч', adminActive7d: 'Актив 7д', adminActive30d: 'Актив 30д', adminEntries: 'Записей', adminAiCost: 'AI-косты, $', adminAiDaily: 'AI по дням (7д)', adminFeatures: 'Топ фич',
        enterHeightWeight: 'Укажи рост и вес',
        bmiLow: 'Недовес', bmiNormal: 'Норма', bmiOver: 'Избыток',
        bmiSevereThin: 'Резкий недовес', bmiModerateThin: 'Умеренный недовес', bmiMildThin: 'Лёгкий недовес',
        bmiObese1: 'Ожирение I', bmiObese2: 'Ожирение II', bmiObese3: 'Ожирение III',
        bmiAthleteNote: 'ИМТ не учитывает мышечную массу',
        whtrTitle: 'ОТ/Рост', preferred: 'точнее',
        whtrUnderweight: 'Недовес', whtrHealthy: 'Норма', whtrRisk: 'Повышенный риск', whtrHighRisk: 'Высокий риск',
        ffmiBelow: 'Ниже среднего', ffmiAvg: 'Среднее', ffmiAbove: 'Выше среднего', ffmiExcellent: 'Отлично', ffmiElite: 'Элита', ffmiExceptional: 'Исключительно',
        fatEssential: 'Эссенциальный', fatAthlete: 'Атлет', fatFitness: 'Фитнес', fatAverage: 'Среднее', fatObese: 'Ожирение',
        ...
        outOf: 'из', kcalLeft: 'осталось, ккал', kcalOver: 'перебор, ккал', goal: 'цель', eaten: 'съедено', nothingAdded: 'Ничего не добавлено', mealsTitle: 'Приёмы пищи',
        custom: '＋ свой',
        ...
        applyDay: 'Применить в дневник', mealPlanNone: 'Активного плана нет — нажми «Сгенерировать»', tips: 'Подсказки', confirmApplyDay: 'Применить день ', toDiary: ' в дневник?', appliedEntries: 'Добавлено записей: ', confirmDeletePlan: 'Удалить план?', mealPlanGenerating: 'Генерируем меню… 30-60 сек', mealPlanReady: 'Готово!', searchOnline: 'Искать в сети', mealPlanExpired: 'Активного плана на сегодня нет — показан последний', mealPlanHistory: 'История планов', shown: 'показан', open: 'Открыть',
    ...
    en: {
        ...
        waistCm: 'Waist circumference, cm', bodyFatPct: 'Body fat %',
        adminPanel: '🛠 Admin', openAdmin: 'Open panel', loading: 'Loading…', historyTitle: '📖 Meal history', historyEmpty: 'No records yet', repeat: 'Repeat', repeatDay: 'Repeat day', otherMeal: 'Other', repeatDayConfirm: 'Copy this day into today', addedToToday: 'Added to today',
        adminOverview: 'Overview', adminUsers: 'Users', adminActive24h: 'Active 24h', adminActive7d: 'Active 7d', adminActive30d: 'Active 30d', adminEntries: 'Entries', adminAiCost: 'AI cost, $', adminAiDaily: 'AI by day (7d)', adminFeatures: 'Top features',
        enterHeightWeight: 'Enter height and weight',
        bmiLow: 'Underweight', bmiNormal: 'Normal', bmiOver: 'Overweight',
        bmiSevereThin: 'Severe thinness', bmiModerateThin: 'Moderate thinness', bmiMildThin: 'Mild thinness',
        bmiObese1: 'Obesity I', bmiObese2: 'Obesity II', bmiObese3: 'Obesity III',
        bmiAthleteNote: 'BMI does not account for muscle mass',
        whtrTitle: 'WHtR', preferred: 'more accurate',
        whtrUnderweight: 'Underweight', whtrHealthy: 'Healthy', whtrRisk: 'Increased risk', whtrHighRisk: 'High risk',
        ffmiBelow: 'Below average', ffmiAvg: 'Average', ffmiAbove: 'Above average', ffmiExcellent: 'Excellent', ffmiElite: 'Elite', ffmiExceptional: 'Exceptional',
        fatEssential: 'Essential fat', fatAthlete: 'Athlete', fatFitness: 'Fitness', fatAverage: 'Average', fatObese: 'Obese',
        ...
        outOf: 'of', kcalLeft: 'left, kcal', kcalOver: 'over, kcal', goal: 'goal', eaten: 'eaten', nothingAdded: 'Nothing added', mealsTitle: 'Meals',
        custom: '＋ custom',
        ...
        applyDay: 'Apply to diary', mealPlanNone: 'No active plan — tap Generate', tips: 'Tips', confirmApplyDay: 'Apply day ', toDiary: ' to diary?', appliedEntries: 'Entries added: ', confirmDeletePlan: 'Delete this plan?', mealPlanGenerating: 'Generating menu… 30-60s', mealPlanReady: 'Done!', searchOnline: 'Search online', mealPlanExpired: 'No plan for today — showing the latest', mealPlanHistory: 'Plan history', shown: 'shown', open: 'Open',
    ...
    ja: {
        ...
        waistCm: 'ウエスト周囲径 (cm)', bodyFatPct: '体脂肪率 (%)',
        adminPanel: '🛠 管理', openAdmin: 'パネルを開く', loading: '読み込み中…', historyTitle: '📖 食事履歴', historyEmpty: 'まだ記録がありません', repeat: '繰り返す', repeatDay: '1日分を繰り返す', otherMeal: 'その他', repeatDayConfirm: 'この日を今日にコピー', addedToToday: '今日に追加しました',
        adminOverview: '概要', adminUsers: 'ユーザー数', adminActive24h: 'アクティブ24h', adminActive7d: 'アクティブ7d', adminActive30d: 'アクティブ30d', adminEntries: '記録数', adminAiCost: 'AIコスト ($)', adminAiDaily: '日別AI (7日)', adminFeatures: '人気機能',
        enterHeightWeight: '身長と体重を入力してください',
        bmiLow: '低体重', bmiNormal: '標準', bmiOver: '過体重',
        bmiSevereThin: '高度低体重', bmiModerateThin: '中等度低体重', bmiMildThin: '軽度低体重',
        bmiObese1: '肥満I度', bmiObese2: '肥満II度', bmiObese3: '肥満III度',
        bmiAthleteNote: 'BMIは筋肉量を考慮していません',
        whtrTitle: 'WHtR', preferred: 'より正確',
        whtrUnderweight: '低体重', whtrHealthy: '標準', whtrRisk: 'リスク増加', whtrHighRisk: '高リスク',
        ffmiBelow: '平均以下', ffmiAvg: '平均', ffmiAbove: '平均以上', ffmiExcellent: '優秀', ffmiElite: 'エリート', ffmiExceptional: '非常に優秀',
        fatEssential: '必須脂肪', fatAthlete: 'アスリート', fatFitness: 'フィットネス', fatAverage: '普通', fatObese: '肥満',
        ...
        outOf: '/', kcalLeft: '残り kcal', kcalOver: '超過 kcal', goal: '目標', eaten: '摂取', nothingAdded: '未追加', mealsTitle: '食事',
        custom: '＋ カスタム',
        ...
        applyDay: '日記に反映', mealPlanNone: 'アクティブな献立はありません — 「生成」をタップ', tips: 'ヒント', confirmApplyDay: '日付 ', toDiary: ' を日記に反映しますか?', appliedEntries: '追加した記録数: ', confirmDeletePlan: 'この献立を削除しますか?', mealPlanGenerating: '献立を生成中… 30〜60秒', mealPlanReady: '完了!', searchOnline: 'ネットで検索', mealPlanExpired: '本日の献立はありません — 最新を表示', mealPlanHistory: '献立履歴', shown: '表示中', open: '開く',
